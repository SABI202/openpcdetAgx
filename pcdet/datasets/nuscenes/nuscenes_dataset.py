...
def create_nuscenes_info(version, data_path, save_path, max_sweeps=10, with_cam=False):
    ...
    assert version in ['v1.0-trainval', 'v1.0-test', 'v1.0-mini', 'v1.0-carla']
    ...
    elif version == 'v1.0-carla':
        train_scenes = splits.carla_train
        val_scenes = splits.carla_val
    else:
